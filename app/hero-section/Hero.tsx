    ...
    >
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        ...
        <div className="flex gap-10 text-[#e4ded7] sm:gap-12 md:gap-14 lg:gap-14">
          ...
          <Link
            href="https://instagram.com/sumxnnn_911"
            target="_blank"
        ...
        >
          ...
          >
            <Image
              src={profile}
              priority
              alt="Suman's headshot"
              data-blobity-tooltip="Chiku"
      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
            ...
            <Link
              href="https://www.synauris.com/"
              target="_blank"
              className="underline underline-offset-2 hover:no-underline"
              aria-label="Synauris Website"
            >
              Synauris,
            </Link>{" "}
        ...
        >
          <p className="text-right text-[16px] font-semibold text-[#e4ded7] md:text-[20px]">
            Focused on interfaces and experiences, working remotely from Bhubaneswar,
            India.
          </p>
        </motion.div>
      </div>
