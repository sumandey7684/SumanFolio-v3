      ...
      <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
        ...
        <div className="mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
          <div className="mb-10 flex w-[100%] flex-col gap-4 text-[18px] font-medium  leading-relaxed tracking-wide text-[#e4ded7] md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:mb-16  lg:max-w-[90%] lg:text-[24px] ">
            ...
            <AnimatedBody
              text={
                "Beyond my work as a frontend developer, I'm an active leader in tech communities on campus. As a member of the Google Developer Student Clubs and Google Cloud Community, I've led workshops and mentored other students."
              }
            />
            <AnimatedBody
              text={
                "When I'm not coding, you can find me binge-watching shows, hanging out with friends, cheering on Indian cricket team, or discovering new music in my favorite genres like Bollywood, Instrumentals, and Hip-hop."
              }
            />
            <AnimatedBody
              text={
          ...
          <div className="mb-24 flex w-[100%] flex-col gap-4 text-[18px] font-normal leading-relaxed tracking-wide text-[#e4ded7]/80 sm:mb-32 md:mb-40 md:gap-6 md:text-[16px] md:leading-normal lg:mt-0 lg:mb-16 lg:max-w-[30%] lg:text-[18px]">
            <div className="flex flex-col gap-4 md:gap-3">
              ...
              <AnimatedBody
                text={
                  "JavaScript (ES6+), React, Next.js, TypeScript,React Testing Library, HTML5, Git/GitHub, NextAuth."
                }
              />
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <AnimatedBody
                text={
                  "Figma, Framer, Canva, Adobe XD, ProtoPie, Adobe Photoshop, UX Research, UI Design, Prototyping."
                }
              />
            </div>
          </div>
